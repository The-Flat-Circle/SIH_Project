...
import { Shield, AlertTriangle, Cpu, ArrowLeft, Lock } from "lucide-react";
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center p-4 bg-[#020617] overflow-hidden">
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-[940px] h-auto md:h-[520px] rounded-3xl overflow-hidden border border-white/15 bg-slate-950/75 backdrop-blur-2xl shadow-[0_0_80px_rgba(201,151,62,0.1)] grid md:grid-cols-2"
      >
        ...
        {/* RIGHT COLUMN: Clean Google Sign-In Form */}
          ...
          <div className="space-y-6 my-auto">
            <div className="space-y-1.5">
              <h1 className="text-3xl font-extrabold tracking-tight text-white font-serif">
                {activeRoleTab === "admin" ? "Admin Control Room Sign-In" : "Tourist Fast-Track Sign-In"}
              </h1>
            ...
            <AnimatePresence>
              {authError && (
                <motion.div
                  ...
                  className="p-4 rounded-xl border border-red-500/40 bg-red-950/60 text-red-200 text-xs flex gap-3 items-start text-left shadow-lg"
                >
