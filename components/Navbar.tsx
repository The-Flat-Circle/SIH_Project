...
import { Cpu, Menu, X, LogIn, UserCheck } from "lucide-react";
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            {/* Right Action: Sign In & Live Demo Buttons */}
            <div className="hidden md:flex items-center gap-3">
              {currentUser ? (
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-dusk-indigo border border-temple-gold/40 text-xs font-mono text-temple-gold">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 text-xs font-mono text-parchment bg-stone-dark/80 hover:bg-stone-dark border border-sandstone/30 hover:border-temple-gold/60 rounded-lg transition-all"
                >
